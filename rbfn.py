...
if __name__ == '__main__':
    ...
    plt.legend()
    # plt.show()
    plt.savefig('loss - lr='+str(lr)+'rbfn1.png')
    plt.clf()
    ...
    plt.legend()
    # plt.show()
    plt.savefig('acc-lr='+str(lr)+'rbfn1.png')
    plt.clf()
    ...
    for w in total_w:
        plt.plot(w)
    # plt.show()
    plt.savefig('weights_rbfn1-lr='+str(lr)+'.png')
    plt.clf()

    # total_w = []
    # for param in params_history:
    #     now_all_w = param['w2'].reshape(-1)
    #     # print(now_all_w.shape)
    #     # print(now_all_w)
    #     total_w.append(now_all_w.tolist())
    # total_w = np.transpose(np.array(total_w))
    ...
    for w in total_w:
        plt.plot(w)
    # plt.show()
    plt.savefig('bias_rbfn1-lr='+str(lr)+'.png')
    plt.clf()

    # total_w = []
    # for param in params_history:
    #     now_all_w = param['b2'].reshape(-1)
    #     # print(now_all_w.shape)
    #     # print(now_all_w)
    #     total_w.append(now_all_w.tolist())
    # total_w = np.transpose(np.array(total_w))
